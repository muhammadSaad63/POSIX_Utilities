...
| 2 | `echo` | Displays a line of text/string | ✅ |
| 3 | `pwd` | Prints the current working directory | ✅ |
| 4 | `sleep` | Delays for a specified amount of time | [ ] |
| 5 | `whoami` | Displays the effective user ID | ✅ |
| 6 | `cd` | Changes the working directory | ✅ |
| 7 | `cp` | Copies files and directories | [ ] |
| 8 | `ls` | Lists directory contents | ✅ |
| 9 | `mkdir` | Creates a new directory | ✅ |
| 10 | `mv` | Moves or renames files/directories | [ ] |
...
| 19 | `nano` | Simple terminal-based text editor | [ ] |
